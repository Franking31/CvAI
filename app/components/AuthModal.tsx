...
type Props = {
  onClose: () => void;
  /** Message affiché au-dessus du form pour expliquer pourquoi on demande la connexion */
  reason?: string;
};
    ...
    >
      <Card className="w-full max-w-md relative shadow-2xl">
        ...
        <CardHeader className="text-center pb-2">
          ...
          {reason && (
            <CardDescription className="text-sm mt-1 bg-primary/5 border border-primary/20 rounded-lg px-3 py-2 text-primary">
              {reason}
            </CardDescription>
          )}
        </CardHeader>
